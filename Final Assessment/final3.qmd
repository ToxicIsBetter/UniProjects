...
- **IoT Sensors**: Devices such as inductive loop detectors, radar sensors, and LIDAR systems placed along roads to measure vehicle flow and density [@fhwa_emerging_technologies; @goodvision_traffic_data].
...
- **Databases**: Extract historical traffic data from SQL/NoSQL databases using queries or data pipelines [@snowflake_traffic_management].
...
1. **Computer Vision**
   ...
   - **Semantic Segmentation**: Models like U-Net for detecting vehicles in dense traffic scenarios [@researchgate_intelligent_traffic].
2. **Machine Learning**
...
- **Intersection Analysis**: Visual comparisons of traffic at different intersections [@intellias_intelligent_traffic; @dc_velocity_itms].
...
- **Edge Computing**: Run models on devices close to the source, such as traffic cameras [@intel_intelligent_traffic; @tomtom_data_driving].
